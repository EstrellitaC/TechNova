...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container">
    <a class="navbar-brand" href="index.php">TechNova</a>
    ...
    <div class="collapse navbar-collapse" id="navbarsExample07">
      ...
      <ul class="navbar-nav">
        ...
        <?php else: ?>
          <li class="nav-item"><span class="navbar-text text-white me-2">Hola, <?=htmlspecialchars($_SESSION['user']['nombre'])?></span></li>
